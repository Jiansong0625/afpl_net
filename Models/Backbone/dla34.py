...
class CBAM(nn.Module):
    def __init__(self, channels, reduction=16, kernel_size=7):
        ...
        self.channel_attention = SE_Block(channels, reduction)
    ...
    def forward(self, x):
        ...
        spatial = self.spatial_attention(x_cat)
        return x_out * spatial
...
class BasicBlock(nn.Module):
    def __init__(self, inplanes, planes, stride=1, dilation=1):
        ...
        self.conv1=SeparableConv2d(inplanes,
                                   planes,
                                   kernel_size=3,
                                   stride=stride,
                                   padding=dilation,
        ...
        self.conv2 = SeparableConv2d(planes,
                                   planes,
                                   kernel_size=3,
                                   stride=1,
                                   padding=dilation,
